...
def generate_launch_description():
    ...
    openvla_config  = os.path.join(pkg_share, 'config', 'openvla_oft.yaml')
    ...
    def create_nodes(context):
        ...
        openvla_node = Node(
            ...
            executable='openvla_oft_node',
            name='openvla_oft_node',
            output='screen',
            parameters=[openvla_config, joint_names_param],
        )
        ...
        return [openvla_node, smoother_node]
