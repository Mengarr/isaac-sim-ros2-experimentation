...
act_inference.py
----------------
ROS2 node that runs ACTPolicy against an SO-101 arm in Isaac Sim.
...
class ACTInferenceNode(Node):
    def __init__(self):
        ...
        if lora_adapter_path:
            ...
            self._policy = ACTPolicy.from_pretrained(base_path)
        ...
        self._reset_episode()
        self.get_logger().info("ACTInferenceNode ready.")
